...
The first name, contact number and balance of all the customer whose account type starts with "Sa". The output should be ordered by the customer's first name.
